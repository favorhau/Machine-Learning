...
data_path = {
'omniglot': "/prototypical-noise/data/omniglot/data",
'miniimagenet': "/prototypical-noise/data/miniimagenet/data/train",
'faces':"./Facial-Similarity-with-Siamese-Networks-in-Pytorch-master/data/faces/training"        
}
